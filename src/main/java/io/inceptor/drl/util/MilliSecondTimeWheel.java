...
public class MilliSecondTimeWheel {
  ...
  public static void start() {
    ...
    if (started == 1){
      ...
      SecondTimeWheelTask.task = schedulor.scheduleAtFixedRate(SecondTimeWheelTask.instance, 0, 1, TimeUnit.MILLISECONDS);
    }
  }
  ...
  public static class SecondTimeWheelTask implements Runnable{
    ...
    public void run() {
      MilliSecondTimeWheel.currentMillisecond = System.currentTimeMillis();
    }
  }
}
